...
async def analyze_brand_and_generate_prompts(website: str, country: str | None = None) -> dict:
    """Analyze a brand website and return brand info + 20 prompts.
...
4. "prompts": an array of exactly 20 detailed buyer questions that someone would type into ChatGPT when seriously researching a purchase in this category. These questions should:
   ...
   - Cover 5 categories with exactly 4 questions per category: 2 generic + 2 branded
     - GENERIC questions (2 per category): Do NOT mention the brand name at all. These should elicit brand recommendations organically.
     - BRANDED questions (2 per category): Explicitly name the brand (the one you identified above) in the question (e.g., "Is [BrandName] worth it for...", "How does [BrandName] compare to..."). These measure how LLMs respond when the brand is directly asked about.
   - The 5 categories are:
     1. "discovery": Ask for top picks, trending brands, or what's popular right now (e.g., generic: "What are the top 5 laptop brands for video editing under $1500?", branded: "Is [BrandName] a good choice for video editing compared to other brands?")
     2. "comparison": Ask for direct comparisons, alternatives, or switching advice (e.g., generic: "How do ultrabook laptops compare to gaming laptops for a CS student who also games?", branded: "How does [BrandName] stack up against its main competitors in terms of value?")
     3. "budget": Ask for affordable recommendations with a price constraint (e.g., generic: "Which running shoe brands offer the best value under $100 for marathon training?", branded: "Is [BrandName] worth the price compared to cheaper alternatives?")
     4. "use_case": Ask about solving a specific problem or professional/business needs (e.g., generic: "I have flat feet and need shoes with strong arch support — which brands should I look at?", branded: "Would [BrandName] work well for someone who needs strong arch support?")
     5. "beginner": Ask as a newcomer to the category, or about durability/reliability (e.g., generic: "I've never bought running shoes for serious training — what brands should a beginner consider?", branded: "Is [BrandName] a good option for someone just getting into serious running?")
   - Each question must have a "question_text" and a "category_context" using the format "<category>_generic" or "<category>_branded" (e.g., "discovery_generic", "discovery_branded", "budget_generic", "budget_branded")
